...
<html lang="th">
  <head>
    ...
    <title>Nagoya Takayama (TG) 7D5N 30 SEP - 6 OCT 2026</title>
  ...
  <div id="app" class="h-full overflow-auto w-full">
   ...
   <header class="hero-bg text-white px-4 py-10 md:py-16 text-center relative z-10">
    <div class="max-w-4xl mx-auto relative z-10">
     ...
     <div class="flex items-center justify-center gap-4 mt-4 text-sm opacity-80">
      <span>📅 30 กันยายน – 6 ตุลาคม 2569</span> 
     </div>
     <div class="flex flex-wrap justify-center gap-2 mt-6">
      <span class="bg-white/20 backdrop-blur px-3 py-1 rounded-full text-xs">TAKAYAMA</span>
      <span class="bg-white/20 backdrop-blur px-3 py-1 rounded-full text-xs">KAMIKOCHI</span>
      <span class="bg-white/20 backdrop-blur px-3 py-1 rounded-full text-xs">NAGOYA</span>
     </div>
    </div>
   </header>
   ...
   <main class="max-w-5xl mx-auto px-4 py-8">
    ...
    <section id="sec-flights" class="tab-section active fade-in">
     ...
     <div class="space-y-4 mb-8">
      <div class="bg-white border border-brand/20 rounded-2xl p-5 card-hover">
       <div class="flex items-center gap-2 mb-3">
        <span class="bg-brand text-white px-3 py-1 rounded-full text-xs font-semibold">TG 644</span>
        <span class="text-sm text-subtle">THAI AIRWAYS</span>
       </div>
       <div class="flex items-center gap-4">
        <div class="text-center">
         <p class="text-2xl font-bold text-brand-dark">00:05</p>
         <p class="text-sm font-medium">BKK</p>
         <p class="text-xs text-subtle">กรุงเทพฯ</p>
         <p class="text-xs text-subtle">1 ต.ค.</p>
        </div>
        <div class="flex-1 flex flex-col items-center">
         <p class="text-xs text-subtle mb-1">5 ชม. 55 นาที</p>
        ...
        <div class="text-center">
         <p class="text-2xl font-bold text-brand-dark">08:00</p>
         <p class="text-sm font-medium">NGO</p>
         <p class="text-xs text-subtle">นาโกย่า</p>
         <p class="text-xs text-subtle">1 ต.ค.</p>
        </div>
       </div>
      </div>
     ...
     <h3 class="font-semibold text-brand mb-3">🛫 ขากลับ — 6 ตุลาคม 2569</h3>
     <div class="space-y-4 mb-8">
      <div class="bg-white border border-brand/20 rounded-2xl p-5 card-hover">
       <div class="flex items-center gap-2 mb-3">
        <span class="bg-brand text-white px-3 py-1 rounded-full text-xs font-semibold">TG 645</span>
        <span class="text-sm text-subtle">THAI AIRWAYS</span>
       </div>
       <div class="flex items-center gap-4">
        <div class="text-center">
         <p class="text-2xl font-bold text-brand-dark">11:00</p>
         <p class="text-sm font-medium">NGO</p>
         <p class="text-xs text-subtle">นาโกย่า</p>
         <p class="text-xs text-subtle">6 ต.ค.</p>
        </div>
        <div class="flex-1 flex flex-col items-center">
         <p class="text-xs text-subtle mb-1">6 ชม. 00 นาที</p>
         <div class="w-full flex items-center">
          <div class="w-2 h-2 rounded-full bg-brand"></div>
          <div class="flex-1 h-[2px] bg-gradient-to-r from-brand to-brand-dark"></div>
          <span class="text-lg">✈️</span>
        ...
        <div class="text-center">
         <p class="text-2xl font-bold text-brand-dark">15:00</p>
         <p class="text-sm font-medium">BKK</p>
         <p class="text-xs text-subtle">กรุงเทพฯ</p>
         <p class="text-xs text-subtle">6 ต.ค.</p>
        </div>
     ...
     <div id="day-1" class="day-content w-full">
      <div class="day-card bg-white rounded-2xl p-6 shadow-sm border border-brand/10">
       <div class="flex items-center gap-3 mb-4">
        ...
        <div>
         <h3 class="font-semibold text-lg">วันพุธที่ 30 กันยายน 2569</h3>
       ...
       <div class="space-y-4 ml-5 border-l-2 border-brand/20 pl-6">
        <div class="relative">
         ...
         <p class="text-sm"><span class="font-semibold text-brand">21:00 น.</span> — คณะพบกันที่ สนามบินสุวรรณภูมิ อาคารผู้โดยสารขาออกระหว่างประเทศ ชั้น 4 ประตู 4 เคาน์เตอร์ H สายการบินไทย เจ้าหน้าที่บริษัทบลูฟลาย ทราเวิลคอยให้การต้อนรับและอำนวยความสะดวก</p>
        </div>
...
<div id="day-2" class="day-content" style="display:none;">
      <div class="day-card bg-white rounded-2xl p-6 shadow-sm border border-brand/10">
       ...
       <div class="space-y-4 ml-5 border-l-2 border-brand/20 pl-6">
        ...
        <div class="relative">
         <div class="timeline-dot absolute -left-[31px] top-1"></div>
         <p class="text-sm"><span class="font-semibold text-brand">00:05 น.</span> — ✈️ สนามบินนาโกย่า โดยสายการบินไทย เที่ยวบินที่ TG 644</p>
        </div>

        <div class="relative">
         <div class="timeline-dot absolute -left-[31px] top-1"></div>
         <p class="text-sm"><span class="font-semibold text-brand">08:00 น.</span> — ✈️ คณะเดินทางถึง สนามบินนาโกย่า ประเทศญี่ปุ่น หลังผ่านพิธีการตรวจคนเข้าเมืองและศุลกากรเรียบร้อยแล้ว (เวลาท้องถิ่นเร็วกว่าประเทศไทย 2 ชั่วโมง)</p>
        </div>
      ...
      <div class="day-card bg-white rounded-2xl p-6 shadow-sm border border-brand/10">
       <div class="flex items-center gap-3 mb-4">
        ...
        <div>
         ...
         <p class="text-sm text-subtle">ทาคายาม่า → ชินโฮทากะโรปเวย์ → ทาคายาม่า</p>
        </div>
...
varieties of fresh seafood. Served with a side dish, crab miso soup, and Japanese pickles.</p>
        ...
        <div class="relative">
         <div class="timeline-dot absolute -left-[31px] top-1"></div>
         <div class="text-sm">
          <p class="font-semibold">🛕 เมืองทาคาโอกะ (Takaoka)  - วัดซุยริวจิ (Zuiryuji Temple)</p>
          <p class="text-subtle mt-1">เดินทางสู่ เมืองทาคาโอกะ (Takaoka) เมืองเก่าแก่ทรงเสน่ห์ที่อบอวลไปด้วยกลิ่นอายประวัติศาสตร์และงาน
...
เรียกหมู่บ้านในสไตล์นี้ว่า กัสโช พร้อมกันนี้ท่านจะเพลิดเพลินกับฝูงปลาคราฟนับร้อยที่แหวกว่ายอยู่ตามลำธารหน้าบ้านซึ่งจะเห็นได้ก็แต่เมืองในแถบนี้เท่านั้น
        ...
        <div class="relative">
         ...
         <div class="text-sm">
          <p class="font-semibold">จากนั้นเดินทางกลับสู่ เมืองนาโกย่า (Nagoya) เมืองหลวงแห่งจังหวัดไอจิ (Aichi) ที่มีขนาดใหญ่ที่สุดในภูมิภาคชูบุ และเป็นเมืองที่ใหญ่เป็นอันดับ 4 ของประเทศญี่ปุ่น</p>
          <div>
          </div>
         </div>
        </div>
  ...
  <div class="day-card bg-white rounded-2xl p-6 shadow-sm border border-brand/10">
    <div class="flex items-center gap-3 mb-4">
      ...
      <div>
        ...
        <p class="text-sm text-subtle">นาโกย่า (ประเทศญี่ปุ่น) → กรุงเทพฯ</p>
      </div>
      <span class="ml-auto text-2xl">✈️🏠</span>
    </div>
    <div class="space-y-4 ml-5 border-l-2 border-brand/20 pl-6">
      ...
      <div class="relative">
        <div class="timeline-dot absolute -left-[31px] top-1"></div>
        <div class="text-sm">
          <p class="font-semibold">นำคณะเดินทางสู่ สนามบินนาโกย่า</p>
        </div>
      </div>

      <div class="relative">
        <div class="timeline-dot absolute -left-[31px] top-1"></div>
        <p class="text-sm"><span class="font-semibold text-brand">11:00 น.</span> — ✈️ ออกเดินทางจากสนามบินนาโกย่า โดยสายการบินไทย เที่ยวบินที่ TG 645</p>
      </div>

      <div class="relative">
        <div class="timeline-dot absolute -left-[31px] top-1"></div>
        <p class="text-sm"><span class="font-semibold text-brand">15:00 น.</span> — คณะเดินทางถึง สนามบินสุวรรณภูมิ โดยสวัสดิภาพ</p>
      </div>
    </div>
  </div>
</div><!-- /day-7 -->
...
<section id="sec-country" class="tab-section fade-in">
  <h2 class="font-display text-2xl md:text-3xl font-bold text-brand-dark mb-6">🗾 ข้อมูลประเทศญี่ปุ่น</h2>
  <div class="grid md:grid-cols-2 gap-4 mb-6">
    <div class="bg-brand-50 rounded-2xl p-5 border border-brand/10">
      ...
      <div class="space-y-2 text-sm">
        <div class="flex justify-between"><span class="text-subtle">ชื่อทางการ</span><span class="font-medium">Nippon-koku / Japan</span></div>
        <div class="flex justify-between"><span class="text-subtle">เมืองหลวง</span><span class="font-medium">โตเกียว (Tokyo)</span></div>
        <div class="flex justify-between"><span class="text-subtle">ภาษาราชการ</span><span class="font-medium">ภาษาญี่ปุ่น (Japanese)</span></div>
        <div class="flex justify-between"><span class="text-subtle">สกุลเงิน</span><span class="font-medium">เยน (JPY / ¥)</span></div>
        <div class="flex justify-between"><span class="text-subtle">เวลาท้องถิ่น</span><span class="font-medium">GMT+9 (เร็วกว่าไทย 2 ชม.)</span></div>
        <div class="flex justify-between"><span class="text-subtle">ปลั๊กไฟ</span><span class="font-medium">Type A (100V / 50-60Hz)</span></div>
        <div class="flex justify-between"><span class="text-subtle">ประชากร</span><span class="font-medium">~124 ล้านคน</span></div>
        <div class="flex justify-between"><span class="text-subtle">เบอร์ฉุกเฉิน</span><span class="font-medium">ตำรวจ 110 / เพลิง-กู้ภัย 119</span></div>
      </div>
    </div>
    <div class="bg-brand-50 rounded-2xl p-5 border border-brand/10">
  ...
  <div class="mt-6 bg-amber-50 border border-amber-200 rounded-2xl p-5">
    ...
    <ul class="text-sm text-amber-700 space-y-2">
      <li>• <strong>ห้ามทิป:</strong> การให้ทิปในญี่ปุ่นถือเป็นเรื่องหยาบคาย ไม่มีวัฒนธรรมการให้ทิปในร้านอาหาร โรงแรม หรือแท็กซี่</li>
      <li>• <strong>ถอดรองเท้าก่อนเข้า:</strong> ต้องถอดรองเท้าก่อนเข้าบ้าน ร้านอาหารแบบดั้งเดิม วัด และที่พักสไตล์ญี่ปุ่น (ริวกัง) ควรสวมรองเท้าที่ถอดง่าย</li>
      <li>• <strong>รถไฟ/ขนส่งสาธารณะ:</strong> ห้ามพูดโทรศัพท์เสียงดัง ห้ามรับประทานอาหาร และควรปิดเสียงโทรศัพท์บนรถ</li>
      <li>• <strong>ออนเซ็น (บ่อน้ำแร่):</strong> ต้องอาบน้ำทำความสะอาดร่างกายให้เรียบร้อยก่อนลงบ่อเสมอ ห้ามนำผ้าขนหนูลงในบ่อ และโดยทั่วไปห้ามผู้ที่มีรอยสักใช้ออนเซ็นสาธารณะ</li>
      <li>• <strong>รับของด้วยสองมือ:</strong> การรับสิ่งของ นามบัตร หรือเงินทอนด้วยสองมือแสดงถึงความเคารพ</li>
      <li>• <strong>ขยะ:</strong> ถังขยะสาธารณะหายากมากในญี่ปุ่น ควรพกถุงเก็บขยะส่วนตัวไว้กับตัว</li>
      <li>• <strong>ห้ามกินขณะเดิน:</strong> ในเมืองส่วนใหญ่ การรับประทานอาหารขณะเดินถนนถือเป็นมารยาทที่ไม่ดี ควรหยุดทานที่จุดที่กำหนด</li>
      <li>• <strong>ตรงต่อเวลา:</strong> ชาวญี่ปุ่นให้ความสำคัญกับความตรงเวลามาก ไม่ควรมาสาย</li>
    </ul>
  </div>

  <div class="grid md:grid-cols-2 gap-4 mt-6">
    <div class="bg-brand-50 rounded-2xl p-5 border border-brand/10">
      <h4 class="font-semibold text-brand-dark mb-3">🗣️ ภาษาญี่ปุ่นพื้นฐาน</h4>
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
        <div class="bg-white/60 rounded-lg p-2"><span class="font-medium">Konnichiwa (โคนิจิวะ)</span><span class="text-subtle"> — สวัสดี</span></div>
        <div class="bg-white/60 rounded-lg p-2"><span class="font-medium">Arigatou (อาริกาโตะ)</span><span class="text-subtle"> — ขอบคุณ</span></div>
        <div class="bg-white/60 rounded-lg p-2"><span class="font-medium">Sumimasen (ซุมิมาเซ็น)</span><span class="text-subtle"> — ขอโทษ/ขอทาง</span></div>
        <div class="bg-white/60 rounded-lg p-2"><span class="font-medium">Ikura desu ka? (อิคุระ เดสุ กะ)</span><span class="text-subtle"> — ราคาเท่าไหร่?</span></div>
        <div class="bg-white/60 rounded-lg p-2"><span class="font-medium">Itadakimasu (อิตาดากิมาสุ)</span><span class="text-subtle"> — ก่อนรับประทานอาหาร</span></div>
        <div class="bg-white/60 rounded-lg p-2"><span class="font-medium">Doko desu ka? (โดโกะ เดสุ กะ)</span><span class="text-subtle"> — อยู่ที่ไหน?</span></div>
        <div class="bg-white/60 rounded-lg p-2"><span class="font-medium">Onegaishimasu (โอเนไก ชิมาสุ)</span><span class="text-subtle"> — ได้โปรด/ขอด้วย</span></div>
        <div class="bg-white/60 rounded-lg p-2"><span class="font-medium">Wakarimasen (วาคาริมาเซ็น)</span><span class="text-subtle"> — ไม่เข้าใจ</span></div>
      </div>
    </div>
    <div class="bg-brand-50 rounded-2xl p-5 border border-brand/10">
...
<section id="sec-clothing" class="tab-section fade-in">
  ...
  <div class="space-y-3">
    <div class="bg-white border-l-4 border-gray-300 rounded-r-xl p-4">
      <p class="font-semibold text-sm">วันที่ 1 | กรุงเทพฯ → สนามบิน (30 ก.ย.)</p>
  ...
  <div class="mt-6 bg-amber-50 border border-amber-200 rounded-2xl p-5">
   ...
   <footer class="bg-brand-dark text-white text-center py-6 px-4">
    <p class="text-sm opacity-80" id="footerText">Japan (Takayama-Kamikochi-Nagoya) (TG)</p>
    <p class="text-xs opacity-50 mt-1">30 กันยายน - 6 ตุลาคม 2569 | 7 วัน 5 คืน</p>
   </footer>
  </div>
